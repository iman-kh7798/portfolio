...
import {faSearch, faShoppingCart,faChevronDown,faBars} from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        <nav className='flex_container' >
            ...
            <div id='search' className='flex_container'>
                ...
                <a href='#' style={{display:'none'}} id='responsive_nav_wrapper'><FontAwesomeIcon icon={faBars} className='wht_clr' style={{fontSize: '25px'}}/></a>
            </div>
        </nav>
    );
